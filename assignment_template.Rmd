...
write_csv(penguins_raw, "Reproducible_science/data/penguins_raw.csv")
...
I will be exploring the relationship between flipper length and body mass in chinstrap penguins.
...
I am first carrying out a normality test to check if the data set is approximately normally distributed so I can carry out a parametric statistical test.
